	...
	public static void main(String[] args)
	{
		...
		if (conn != null)
		{
			...
			try
			{
				...
				// excuteQuery() 메소드를 사용하면
				// 질의 결과를 ResultSet 객체로 가져올 수 있다.
				// 하지만, ReaultSet 객체가 질의에 대한 결과물 모두를
				// 한꺼번에 받아서 가지고있는 구조가 아니다.
				// 단지, 데이터베이스로부터 획득한 질의 결과물에 대한
				// 관리가 가능한 상태가 되는것이다.
				// 이 때문에...ResultSet 을 수신했다고 해서  (무전기)
				// 데이터베이스와의 연결을 끊게되면
				...
				{
					// 레코드에서 결과값을 가져오는 것은 getter() 
					// getXxx() -- getString() , getInt() 
